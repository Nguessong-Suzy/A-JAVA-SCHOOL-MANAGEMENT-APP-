 ...
 * @author BOSS
 */
public class admincalender extends javax.swing.JFrame {

    /**
     * Creates new form admitcalender
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(this, "input studen user ID");
        }
        else if(event.getText().length()== 0)
        {
            JOptionPane.showMessageDialog(this, "input the event");
        }
        else if(date.getText().length()== 0)
        {
            JOptionPane.showMessageDialog(this, " No date inserted");
        }
        else
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admincalender.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admincalender().setVisible(true);
            }
        });
    }
